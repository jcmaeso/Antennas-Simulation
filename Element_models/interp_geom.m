...
%
% If interp_config is empty (no sub array defined) just use 
% isotropic element geometry (the 3 coloured axis lines).

if isempty(interp_config)
 geom(1:3,1)=[0 ; 0  ;0  ]; % If you want to display a particular geometry for your interpolated
 geom(1:3,2)=[0 ; 0  ;0  ]; % element here is where to put it. See other _geom files for examples.
 gpflg=0;
else

% Sub array gemetry definition *****
...
end % End sub array geometry definition ****
