function plot_geopat3D(deltheta,delphi,polarisation,normalise,surftype,gpratio)
% Plot 3D pattern and array geometry. 
% Default figure (14)
%
...
%
%
% e.g. plot_geopat3D(10,15,'tot','no','surf',3)
%
%         z
...
if strcmp(polarisation,'ar') | strcmp(polarisation,'tau') | strcmp(polarisation,'phase')  % Plot scaling for ar,tau and phase options
 ...
 set(colorbar,'yticklabel',str2num(char(h)));
else
 h=get(colorbar,'yticklabel');
 set(colorbar,'yticklabel',str2num(char(h))-dBrange_config);
end
