function [XGC,YGC,ZGC,XLC,YLC,ZLC,PlotData]=plot_field_slice1(xrng,xsteps,yrng,ysteps,xrot,yrot,zrot,...
                xoff,yoff,zoff,polarisation,normalise,units,fignum1,fignum2)
% Plot E-field parameters as a slice through 3D space.
%          
% Two field-slice plots are generated:
%
%        1) The first plot (fignum 1) is in global coordinates and is useful for verifying that 
%           the field-slice is where it should be relative to the array. To this end it is
%           best if a 3D geometry plot has already been added to fignum1 using plot_geom3d.
%
%        2) The second plot (fignum 2) is in local coordinates unless the required slice is parallel
%           to one of the primary axis planes, in which case global coordinates are used. This
%           separate, dedicated plot, is more convenient for reading off specific values.
%
%
...
%
% Usage: [XGC,YGC,ZGC,XLC,YLC,ZLC,PlotData]=plot_field_slice1(xrng,xsteps,yrng,ysteps,xrot,yrot,zrot,...
%               xoff,yoff,zoff,polarisation,normalise,units,fignum1,fignum2)
%
...
%
%
% fignum1....Figure number for data plotted in the global coordinate system
% fignum2....Figure number for data plotted in the local coordinate system
%
%
...
%
% Notes on using the plot_field_slice1 function :-
%
...
%         +X
%
%  The plot_field_slice1 function can be called multiple times and each call will
...
%
%  Also bear in mind that the individual plot figures (fignum) will have their own 
