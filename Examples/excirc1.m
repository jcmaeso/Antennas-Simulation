% CIRCULAR POLARISATION METHOD 1 (excirc1)
% 
% Crossed dipoles
% Overlaid and fed in phase quadrature to give RHCP in the Z-axis direction
%
% Try the 'lhcp' plotting option for X-polar response (3D and 2D Plots).
...
plot_theta(-180,5,180,[0,45],'rhcp','each'); 
plot_pattern3d(5,15,'rhcp','no');  
